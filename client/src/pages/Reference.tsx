...
const directionData: Record<Direction, { label: string; title: string; subtitle: string; color: string; icon: typeof Compass; promise: string; strengths: string[] }> = {
  partner: { label: "A / CONTENT PARTNER", title: "让每一个想法，找到可以继续发生的方式。", subtitle: "内容策划与制作 · 老板 IP 起号与培训 · 项目协作", color: "partner", icon: Compass, promise: "最适合让中小企业和品牌方快速知道：你能一起做什么。", strengths: ["合作价值清晰", "商业转化直接", "个人气质温暖可靠"] },
